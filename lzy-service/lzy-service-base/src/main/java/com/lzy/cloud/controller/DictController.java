...
import com.lzy.cloud.dto.CreateDictDTO;
import com.lzy.cloud.dto.DictDTO;
import com.lzy.cloud.dto.QueryDictDTO;
import com.lzy.cloud.dto.UpdateDictDTO;
...
public class DictController {
    ...
    public Result<Boolean> checkUserExist(@RequestBody UpdateDictDTO dictDTO) {
        QueryWrapper<Dict> dictQueryWrapper = Dict.qw();
        ...
        long count = dictService.count(dictQueryWrapper);
